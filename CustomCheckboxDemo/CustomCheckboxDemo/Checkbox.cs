...
namespace CustomCheckboxDemo
{
    public class Checkbox : View
    {
        ...
        public static BindableProperty OutlineColorProperty = BindableProperty.Create(nameof(OutlineColor), typeof(Color), typeof(Checkbox), Color.FromHex("#F6694A"));
        ...
        public static BindableProperty CheckColorProperty = BindableProperty.Create(nameof(CheckColor), typeof(Color), typeof(Checkbox), Color.FromHex("#F6694A"));
